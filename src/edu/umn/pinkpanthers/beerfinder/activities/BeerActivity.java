...
public class BeerActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        hops.setImageDrawable(
        	getResources().getDrawable(
                getResources().getIdentifier(
                    "drawable/hops_" + beer.getHopsRank(), 
                    "drawable", 
                    getPackageName()
                )
            )
        ...
        body.setImageDrawable(
        	getResources().getDrawable(
                getResources().getIdentifier(
                    "drawable/body_" + beer.getBodyRank(), 
                    "drawable", 
                    getPackageName()
                )
            )
        ...
        color.setImageDrawable(
        	getResources().getDrawable(
                getResources().getIdentifier(
                    "drawable/color_" + beer.getColorRank(), 
                    "drawable", 
                    getPackageName()
                )
            )
